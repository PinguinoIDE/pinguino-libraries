/*  ----------------------------------------------------------------------------
    ...
    IMPORTANT RELEASE:   12 jun. 2012
    LAST RELEASE: 9 apr. 2016
    ----------------------------------------------------------------------------
...
// lcdi2c.initpins parameters : number of columns, number of rows, i2c address,
// D4, EN, RW, RS, BackLight (associated pcf8574 pins P0-P7)
    lcdi2c.init(16, 2, 0x27,4,3,2,1,0);  // 27 DIY Pinguino module +noBacklight- pullup resistors exist on the module
// means D4(LCD pin) is connected to P4 (Expander pin), EN to P3, RW to P2, RS to P1, Backlight to P0
