...
u16 alpha=0;  // rotation angle in degree [0,359]
float x, y;     // coordinates x E [0,159], y E [0, 127]
float xo, yo;   // center of screen

#define Radius 32.00000f
...
void loop()
{
    x = xo + Radius * cosr(alpha);
    y = yo + Radius * sinr(alpha);
