...
void loop()
{
    ...
    // display
    if (f<100)
        ST7565.drawRect(SPIMODULE, x1, y1, x2, y2);
    else if (f<200)
        ST7565.drawRoundRect(SPIMODULE, x1, y1, x2, y2);
    else if (f<300)
        ST7565.fillRect(SPIMODULE, x1, y1, x2, y2);
    else if (f<400)
        ST7565.fillRoundRect(SPIMODULE, x1, y1, x2, y2);
