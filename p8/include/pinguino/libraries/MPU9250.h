...
#define MPU9250_whoami(module)  MPU9250_readChar(module, MPU9250_WHOAMI)
...
#define AK8963_whoami(module)   AK8963_readChar(module, AK8963_WIA)
#define AK8963_getCNTL1(module) AK8963_readChar(module, AK8963_CNTL1)
