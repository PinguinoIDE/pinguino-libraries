...
uint16_t m_stack_winusb_get_microsoft_compat(uint8_t interface, const void **descriptor);

uint16_t m_stack_winusb_get_microsoft_property(uint8_t interface, const void **descriptor);
