...
/*--------------------------------------------------------------------*/
    ...
    #define USB_INT_NUM                     HID_INT_NUM      // Nb interfaces
    #define USB_EP_NUM                      HID_EP_NUM       // Nb endpoints
    ...
    #define USB_INT_NUM                     BULK_INT_NUM     // Nb interfaces
    #define USB_EP_NUM                      BULK_EP_NUM      // Nb endpoints
    #define USB_EP0_BUFF_SIZE               8                // BULK_COMM_IN_EP_SIZE
    #define USB_POLLING_PERIOD              1                // ms - must be > 0
