...
void ST7735_sendCommand(u8);
void ST7735_sendData(u8);
#if defined(SPISW)
void ST7735_init(u8, u8, u8, u8);
#else
...
void ST7735_clearWindow(u8,u8,u8,u8);
//void ST7735_scrollRight();
//void ST7735_scrollLeft();
//void ST7735_scrollUp();
//void ST7735_scrollDown();
void ST7735_setFont(const u8*);
void ST7735_printChar(u8);
void ST7735_print(u8*);
void ST7735_println(u8*);
void ST7735_printNumber(long, u8);
void ST7735_printFloat(float, u8);
void ST7735_printf(const u8*, ...);
void ST7735_setCursor(u8, u8);
void ST7735_drawPixel(u8, u8);
void ST7735_clearPixel(u8, u8);
void ST7735_drawBitmap(u16, u16, u16, u16, u16*);
void ST7735_drawCircle(u16, u16, u16);
void ST7735_fillCircle(u16, u16, u16);
void ST7735_drawLine(u16, u16, u16, u16);
void ST7735_drawVLine(u16, u16, u16);
void ST7735_drawHLine(u16, u16, u16);

void drawPixel(u16, u16);
void drawVLine(u16, u16, u16);
void drawHLine(u16, u16, u16);

color_t ST7735_getColor(u8, u8);

#define ST7735_getFontWidth()   (ST7735.font.width)
#define ST7735_getFontHeight()  (ST7735.font.height)
#define ST7735_invertDisplay()  ST7735_sendCommand(ST7735_INVON)
#define ST7735_normalDisplay()  ST7735_sendCommand(ST7735_INVOFF)
#define ST7735_displayOn()      ST7735_sendCommand(ST7735_DISPON)
#define ST7735_displayOff()     ST7735_sendCommand(ST7735_DISPOFF)
...
lcd_t ST7735;
    ...
    int ST7735_DCPIN, ST7735_CSPIN;
    #define ST7735_low(x)   { LATBCLR=x; }
    #define ST7735_high(x)  { LATBSET=x; }
#else
    u8 ST7735_DCPIN, ST7735_CSPIN;
    #define ST7735_low(x)   low(x)
    #define ST7735_high(x)  high(x)
#endif

#if defined(SPISW)
    u8 ST7735_SDAPIN, ST7735_SCKPIN;
#endif
