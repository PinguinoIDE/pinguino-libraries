...
/**	--------------------------------------------------------------------
    ...
    #define SSD1306_I2C1                1<<0    // I2C
    #define SSD1306_I2C2                1<<1
    #define SSD1306_SPISW               1<<2    // SPI
    #define SSD1306_SPI1                1<<3
    #define SSD1306_SPI2                1<<4
    #define SSD1306_PMP6800             1<<5    // Parallel port
    #define SSD1306_PMP8080             1<<6 
...
// SPISW, SPI1, SPI2, I2C1, I2C2, PMP6800, PMP8080, PORTD
lcd_t SSD1306[8];
